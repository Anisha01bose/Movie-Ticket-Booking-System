...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                <%
                    ...
                    String query = "SELECT * FROM vellore";
                ...
                <tr>
                    ...
                    <td><form method="POST" action="http://localhost:8080/TestProject_1/Deassign?db=<%=rs.getString(2)%>" onsubmit="return funSub()">
        ...
        <div id="btn">
            ...
            <br>
            <form action="http://localhost:8080/TestProject_1/Pages/HTML%20Pages/DeAssign.jsp" method="post">
